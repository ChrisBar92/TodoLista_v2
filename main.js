...
const prepareDOMElements = () => {
	...
	$ulList = document.querySelector('.todo__body ul')
...
// nie trzeba klikać na przycisk tylko wystarczy wcisnąć enter
const enterCheck = () => {
	if (event.key === 'Enter') {
		addNewTask()
	}
...
const createToolsArea = () => {
	...
	toolsPanel.classList.add('todo__item')
...
//funkcja main dopiero jest uruchamiana jak cały dokument (index, css) zostanie wyrenderowany i załadowane przez przeglądarkę
